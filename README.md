...
1. Diferença entre Construtor Padrão e Construtor Factory:
...
Construtor padrão: quando só precisa criar um objeto simples com seus dados
...
3. O que acontece na linha 134 e a finalidade do setState:
